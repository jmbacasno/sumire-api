...
class TaskRepository:
    ...
    async def update(self, task: Task) -> Task:
        ...
        task_model.due_date = task.repeat_manager.due_date
        task_model.is_completed = task.is_completed
        task_model.is_important = task.is_important
        task_model.repeat_frequency = task.repeat_manager.repeat.frequency
        task_model.repeat_interval = task.repeat_manager.repeat.interval
        task_model.repeat_weekdays = task.repeat_manager.repeat.weekdays_str

        # Manually update updated_at field
